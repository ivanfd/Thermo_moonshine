 ...
 * Author: User
 *
 * Created on 24 но€бр€ 2020 г., 15:45
 */
#ifndef MAIN_H
#define	MAIN_H
...
#define _XTAL_FREQ  8000000 // чатота контролера 8ћ√ц


#define TMR1Val 15536 
#define TMR0Val 45536 //частота перериванн€ при д≥льнику 1:1 буде 25мс


#define SEL_MAIN 1 // основне меню
#define SEL_SET_DQ 2 // налаштуванн€ датчик≥в
